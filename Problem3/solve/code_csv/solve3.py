...
# Load the CSV file
file_path = 'Q2\solve\code_csv\orders_books_3.csv'  # Make sure the file path is correct
...
# Load the CSV file
file_path = 'Q2\solve\code_csv\pallets_books_3.csv'  # Make sure the file path is correct
df = pd.read_csv(file_path)
